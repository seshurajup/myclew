> **Source:** `source.pdf` · 24 pages · 6 figures · 30 display equations · 15 tables · converted by fleet `paper-md` (backend=**docling+pymupdf-assets**)
...
$$f _ { \theta } ( Y \, | \, C , Q ) \triangle q f _ { \theta } ( Y \, | \, [ C ; Q ] ) .  \tag{1} \quad \text {of the}$$
...
$$\mathcal { L } _ { \text {write} } ( \mathcal { M } ; C ) \, = \, - \sum _ { i = 1 } ^ { N } \log f _ { \theta } ( t _ { i } \, | \, [ \mathcal { M } ; t _ { < i } ] ) \, ,  \tag{4} \quad \text {correspond} \quad \text {sample}$$
...
$$\mathcal { M } _ { k + 1 } = \mathcal { M } _ { k } - \alpha \nabla _ { \mathcal { M } _ { k } } \mathcal { L } _ { w r i t e } ( \mathcal { M } _ { k } ; C ) ,  \tag{5} \quad \underset { \ e n c o } { \overset { ( 5 ) } { \ e n c o } }$$
...
$$\hat { \mathcal { M } } \, = \, \mathcal { E } _ { \theta } ( C ) \, \stackrel { \triangle } { = } \, G D _ { K } ( \mathcal { M } _ { 0 } , \, \mathcal { L } _ { w r i t e } ( \cdot ; C ) ) \, .  \tag{6} \quad o b t a i n$$
...
![Figure 1. GradMem learns to write context into memory via](assets/fig/p01_0.png)

*Figure 1. GradMem learns to write context into memory via*

![Figure 2. GradMem overview. (a) Each task sample is represented as context C, qu](assets/fig/p03_0.png)

*Figure 2. GradMem overview. (a) Each task sample is represented as context C, query Q, and target Y . A context encoder Eθ*

![Figure 3. Gradient-based memory updates (GradMem) out-](assets/fig/p07_0.png)

*Figure 3. Gradient-based memory updates (GradMem) out-*

![page 7](assets/fig/p07_1.png)

*page 7*

![page 7](assets/fig/p07_2.png)

*page 7*

![Figure 4. More gradient steps at test-time lead to better per-](assets/fig/p07_3.png)

*Figure 4. More gradient steps at test-time lead to better per-*

### Equation crops — every numbered formula as rendered (8)

**(2)** p3 ![eq](assets/eq/eq_p03_000.png)

**(7)** p4 ![eq](assets/eq/eq_p04_009.png)

**(4)** p4 ![eq](assets/eq/eq_p04_016.png)

**(5)** p4 ![eq](assets/eq/eq_p04_018.png)

**(6)** p4 ![eq](assets/eq/eq_p04_019.png)

**(9)** p18 ![eq](assets/eq/eq_p18_022.png)

**(10)** p18 ![eq](assets/eq/eq_p18_023.png)

**(11)** p18 ![eq](assets/eq/eq_p18_025.png)
