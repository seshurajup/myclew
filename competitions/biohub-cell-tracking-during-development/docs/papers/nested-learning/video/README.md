# Video build inputs — Nested Learning: The Illusion of Deep Learning Architecture
...
**Scenes** 70 · **segments** 70 · **assets** 53 (all present) · **script** ~3477 words ≈ 23.2 min of speech

Build later:
```
kind=shorts-builder  spec={"format":"video","paper":"nested-learning","prefix":"nl"}
```
