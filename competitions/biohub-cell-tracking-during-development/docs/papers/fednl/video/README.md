# Video build inputs — Federated Nested Learning: Collaborative Training of
...
**Scenes** 44 · **segments** 44 · **assets** 17 (all present) · **script** ~1573 words ≈ 10.5 min of speech

Build later:
```
kind=shorts-builder  spec={"format":"video","paper":"fednl","prefix":"fnl"}
```
