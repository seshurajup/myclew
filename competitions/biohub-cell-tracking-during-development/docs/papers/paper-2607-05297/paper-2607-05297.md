> **Source:** `source.pdf` · 14 pages · 10 figures · 33 display equations · 5 tables · converted by fleet `paper-md` (backend=**docling+pymupdf-assets**)
...
$$U ( s ) \, = \, \mathbb { E } _ { ( x , y ) \sim \mathcal { T } } [ r ( A _ { s } ( x ) , y ) ] \, ,  \tag{1} \quad ,$$
...
![Figure 2: System overview. The branch state b = (s, m, h) (left) feeds the five-](assets/fig/p05_2.png)
...
![page 5](assets/fig/p05_5.png)

*page 5*

![page 5](assets/fig/p05_6.png)

*page 5*

![page 5](assets/fig/p05_7.png)

*page 5*

![page 5](assets/fig/p05_8.png)

*page 5*

![page 5](assets/fig/p05_9.png)

*page 5*

### Equation crops — every numbered formula as rendered (1)

**(2)** p4 ![eq](assets/eq/eq_p04_015.png)
