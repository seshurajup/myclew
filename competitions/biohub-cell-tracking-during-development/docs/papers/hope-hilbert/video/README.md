# Video build inputs — Hilbert Operator for Progressive Encoding (HOPE)
...
**Scenes** 62 · **segments** 62 · **assets** 10 (all present) · **script** ~2525 words ≈ 16.8 min of speech

Build later:
```
kind=shorts-builder  spec={"format":"video","paper":"hope-hilbert","prefix":"hpe"}
```
