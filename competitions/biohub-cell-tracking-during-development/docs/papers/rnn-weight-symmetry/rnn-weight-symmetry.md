> **Source:** `source.pdf` · 6 pages · 0 figures · 64 display equations · 0 tables · converted by fleet `paper-md` (backend=**docling+pymupdf-assets**)
...
$$h _ { t } = \tanh ( W _ { x h } x _ { t } + W _ { h h } h _ { t - 1 } ) , \quad h _ { 0 } = 0 ,  \tag{1}$$
...
$$B = \begin{pmatrix} B _ { R } & 0 \\ 0 & B _ { C } \end{pmatrix} , \quad N = \begin{pmatrix} T _ { R R } & T _ { C \rightarrow R } \\ 0 & T _ { C C } \end{pmatrix} .  \tag{5} \quad _ { \Delta T } =$$
...
### Equation crops — every numbered formula as rendered (7)

**(1)** p2 ![eq](assets/eq/eq_p02_001.png)

**(2)** p2 ![eq](assets/eq/eq_p02_002.png)

**(3)** p2 ![eq](assets/eq/eq_p02_003.png)

**(4)** p2 ![eq](assets/eq/eq_p02_004.png)

**(7)** p2 ![eq](assets/eq/eq_p02_006.png)

**(8)** p2 ![eq](assets/eq/eq_p02_008.png)

**(6)** p2 ![eq](assets/eq/eq_p02_016.png)
