# Video build inputs — KIMI K3: OPEN FRONTIER INTELLIGENCE
...
**Scenes** 70 · **segments** 70 · **assets** 17 (all present) · **script** ~2718 words ≈ 18.1 min of speech

Build later:
```
kind=shorts-builder  spec={"format":"video","paper":"kimi-k3","prefix":"k3"}
```
