...
def main() -> None:
    ...
    cfg = PredictConfig(
        ...
        pool_kernel_um=float(os.environ.get("POOL_KERNEL_UM", "3.0")),  # NMS radius; smaller = split merged dense peaks (recall↑)
        threshold=float(os.environ.get("EDGE_THRESHOLD", "0.5")),  # edge-candidate cutoff (lower = more links for the ILP)
