...
- If formal training has already been submitted to `researchpapers/train_service/`, treat yourself as “waiting for external results” rather than continuing to run long training inside the tmux pane.
